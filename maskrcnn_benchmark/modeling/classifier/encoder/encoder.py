def build_classifier_encoder(cfg):
    func = registry.CLASSIFIER_ENCODER[cfg.MODEL.CLASSIFIER.ENCODING_TYPE]
    return func(cfg)
...
@registry.CLASSIFIER_ENCODER.register("MesoInception4")
